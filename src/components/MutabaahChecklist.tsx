      ...
      <div className="p-8">
        ...
        <div className="space-y-6">
          <ChecklistItem
            ...
            checked={checklist.shuburJamaah}
            onChange={(checked) =>
              onChecklistChange({ ...checklist, shuburJamaah: checked })
            }
          />
          ...
          <ChecklistItem
            ...
            checked={checklist.quranReading}
            onChange={(checked) =>
              onChecklistChange({ ...checklist, quranReading: checked })
            }
          />
        </div>
        ...
        <div className="mt-8">
          <button
            ...
            disabled={submitting || submitted || !checklist.shuburJamaah || !checklist.quranReading}
            className={`w-full flex items-center justify-center space-x-2 py-2 px-4 rounded-md transition duration-200 ${
              submitted
                ...
                : !checklist.shuburJamaah || !checklist.quranReading
